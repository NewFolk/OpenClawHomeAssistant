...
This document outlines the security risks associated with running the OpenClaw Assistant - NewFolk Home Assistant add-on and provides best practices for safe usage.
