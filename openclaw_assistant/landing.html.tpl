...
<head>
  ...
  <title>OpenClaw Assistant - NewFolk</title>
  <style>
...
<body>
  <div class="card">
    <h2 style="margin:0 0 4px 0">OpenClaw Assistant - NewFolk</h2>
  ...
  (function() {
    ...
    if (ACCESS_MODE === 'lan_https') {
      ...
      wizardContent.innerHTML = `
        ...
        <p style="font-size:14px"><b>Recommended:</b> Go to <b>Settings → Add-ons → OpenClaw Assistant - NewFolk → Configuration</b>
