...
- Harden the built-in `lan_https` proxy for OpenClaw `2026.8.2+`: proxy identity headers are omitted for same-host loopback clients and overwritten with the socket source for real LAN clients. This restores stale Home Assistant integration entries that still use the HTTPS port, prevents `proxy_attribution_required`, and rejects spoofed inbound `X-Forwarded-For` chains.

## [0.5.76] - 2026-05-04

### Changed
- Bump bundled OpenClaw runtime to 2026.5.2.

## [0.5.75] - 2026-05-02

### Changed
- Bump bundled OpenClaw runtime to 2026.4.29.

## [0.5.74] - 2026-04-29

### Changed
- Bump bundled OpenClaw runtime to 2026.4.26.
...
### Changed
- Bump bundled OpenClaw runtime to 2026.4.23.
- Rename the add-on to **OpenClaw Assistant - NewFolk** across Home Assistant metadata and user-facing docs.

## [0.5.71] - 2026-04-21

### Changed
- Bump OpenClaw to 2026.4.20 (add-on 0.5.71).

## [0.5.70] - 2026-04-17

### Changed
- Bump OpenClaw to 2026.4.15 (add-on 0.5.70).

## [0.5.69] - 2026-04-16

### Changed
- Bump OpenClaw to 2026.4.14 (add-on 0.5.69).
...
For the full commit history, see [GitHub commits](https://github.com/NewFolk/OpenClawHomeAssistant/commits/main).
